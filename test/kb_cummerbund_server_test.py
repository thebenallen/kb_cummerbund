...
class kb_cummerbundTest(unittest.TestCase):
    ...
    def test_your_method(self):
        ...
        ws_id="srividya22:1453129179060"
        ws_obj_id="Ath_exp_cuffdiff"
        ...
        ws_out_id3 = "exp3"
        heatmapParams={'workspace_name': ws_id, 'ws_cuffdiff_id': ws_obj_id, 'ws_expression_matrix_id':ws_out_id3,
		'sample1':'Root_Control', 'sample2' :'Root_prolonged_cold', 'q_value_cutoff':0.05, 'include_inf':0, 'log2_fold_change_cutoff': 2, 'num_genes' :100 ,'include_replicates':1}
