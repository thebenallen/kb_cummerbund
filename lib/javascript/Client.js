...
function kb_cummerbund(url, auth, auth_cb, timeout, async_job_check_time_ms) {
    var self = this;
    ...
    this.generate_cummerbund_plots = function (cummerbundParams, _callback, _errorCallback) {
    ...
    this.generate_cummerbund_plots_async = function (cummerbundParams, _callback, _errorCallback) {
        ...
        return json_call_ajax("kb_cummerbund.generate_cummerbund_plots_async", 
            [cummerbundParams], 1, _callback, _errorCallback);
    };
    ...
    this.create_expression_matrix = function (expressionMatrixParams, _callback, _errorCallback) {
    ...
    this.create_expression_matrix_async = function (expressionMatrixParams, _callback, _errorCallback) {
        ...
        return json_call_ajax("kb_cummerbund.create_expression_matrix_async", 
            [expressionMatrixParams], 1, _callback, _errorCallback);
    };
    ...
    this.create_heatmap_de_genes = function (heatmapParams, _callback, _errorCallback) {
        self.create_heatmap_de_genes_async(heatmapParams, function(job_id) {
            var _checkCallback = null;
            _checkCallback = function(job_state) {
                if (job_state.finished != 0) {
                    if (!job_state.hasOwnProperty('result'))
                    ...
                    setTimeout(function () {
                        self.create_heatmap_de_genes_check(job_id, _checkCallback, _errorCallback);
                    }, self.async_job_check_time_ms);
                }
            };       
            _checkCallback({finished: 0});
    ...
    this.create_heatmap_de_genes_async = function (heatmapParams, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("kb_cummerbund.create_heatmap_de_genes_async", 
            [heatmapParams], 1, _callback, _errorCallback);
    };
    
    this.create_heatmap_de_genes_check = function (job_id, _callback, _errorCallback) {
        if (typeof job_id === 'function')
            throw 'Argument job_id can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        ...
        if (typeof arguments === 'function' && arguments.length > 3)
            throw 'Too many arguments ('+arguments.length+' instead of 3)';
        return json_call_ajax("kb_cummerbund.create_heatmap_de_genes_check", 
            [job_id], 1, _callback, _errorCallback);
    };
 
    this.create_interactive_heatmap_de_genes = function (interactiveHeatmapParams, _callback, _errorCallback) {
    ...
    this.create_interactive_heatmap_de_genes_async = function (interactiveHeatmapParams, _callback, _errorCallback) {
        ...
        return json_call_ajax("kb_cummerbund.create_interactive_heatmap_de_genes_async", 
            [interactiveHeatmapParams], 1, _callback, _errorCallback);
    };
